...
<template>
  <div class="w-full bg-white custom-nav dark:bg-gray-800">
    ...
    <NavigationMenuList>
            ...
            <li class="row-span-3">
              <NavigationMenuLink as-child>
                <a
                  ...
                  href="/"
                >
                  <img src="https://www.radix-vue.com/logo.svg" class="w-6 h-6">
      ...
      <NavigationMenuItem>
        ...
        <div class="items-center hidden space-x-4 cursor-pointer md:flex">
          <a v-for="item in (theme as any).nav" 
             :key="item.text" 
             :href="item.link"
             class="px-2 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700">
            {{ item.text }}
          </a>
        </div>
        <!-- 移动端菜单按钮 -->
