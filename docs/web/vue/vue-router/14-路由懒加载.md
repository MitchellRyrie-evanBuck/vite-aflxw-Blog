...
const router = new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'user-cart',
          component: () =>
            import(/* webpackChunkName: "user" */ './views/User/Cart.vue'),
        },
      ],
    },
    {
    ...
    },
    {
      ...
      name: 'book-choose',
      component: () =>
        import(/* webpackChunkName: "book" */ './views/Book/BookChoose.vue'),
    },
    {
      path: '/book-boy',
      name: 'book-boy',
      component: () =>
        import(/* webpackChunkName: "book" */ './views/Book/BookBoy.vue'),
    },
    {
      path: '/book-girl',
      name: 'book-girl',
      component: () =>
        import(/* webpackChunkName: "book" */ './views/Book/BookGirl.vue'),
    },
  ],
});
